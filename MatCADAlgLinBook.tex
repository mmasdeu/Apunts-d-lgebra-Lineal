...
\hypersetup{pdftitle={Apunts d'Àlgebra Lineal},pdfauthor={Marc Masdeu, Albert Ruiz}} % Uncomment and fill out to include PDF metadata for the author and title of the book
...
{\huge Marc Masdeu, Albert Ruiz}}}; % Author name
\end{tikzpicture}
\vfill
\endgroup
